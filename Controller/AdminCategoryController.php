...
class AdminCategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $keys = array(
            'id',
            'article.admin.category.name.text',
        );
    ...
    public function newAction()
    {
        ...
        $formHandler    = $this->get('black_article.category.form.handler');
    ...
    public function deleteAction($id, $token = null)
    {
        ...
        if ($form->isValid() || true === $token) {
            ...
            $this->get('session')->getFlashBag()->add('success', 'success.article.admin.category.delete');

        } else {
            $this->getFlashBag->add('error', 'error.article.admin.category.not.valid');
        }
    ...
    public function batchAction()
    {
        ...
        if (!$ids = $request->get('ids')) {
            $this->get('session')->getFlashBag()->add('error', 'error.article.admin.category.no.item');

            return $this->redirect($this->generateUrl('admin_category_index'));
        }

        if (!$action = $request->get('batchAction')) {
            $this->get('session')->getFlashBag()->add('error', 'error.article.admin.category.no.action');
        ...
        if (false === $token) {
            $this->get('session')->getFlashBag()->add('error', 'error.article.admin.category.csrf');
